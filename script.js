...
function showVerse() {
    ...
    document.getElementById('verse').style.display = 'block'; // Vers anzeigen
    document.getElementById('verse').innerText = getRandomVerse(); // Zufälligen Vers einfügen
    document.getElementById('like-container').style.display = 'flex'; // Like-Button anzeigen
}
